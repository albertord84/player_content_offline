...
export default class LeftItem extends Component {
  ...
  render() {
    return (
      <div>
        <div className="ant-menu-item MenuItem MenuItem1" onClick={this.setAtivo} style={{backgroundColor:this.state.ativo? 'rgb(31, 71, 141)' : '#ffffff',color:this.state.ativo? '#fff' : '#8d9cab'}}>
